      ...
      setbgimg(){
        ...
        if(screenwidth<768){
          return(
            ...
            <Grid>            
              <iframe src="https://drive.google.com/embeddedfolderview?id=1LA6IgWie-3raJtCvIC37li9ihTglEy-m#grid" width="100%" height="100%" style={{marginTop: "3.5em", color: "black",border: "medium solid black", marginTop: "5em", height: "500px", background:"url('images/hd2flippedmob.jpg')"}} frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
              </Grid>          
              <div><br></br><br></br></div>
                <View
  style={{
